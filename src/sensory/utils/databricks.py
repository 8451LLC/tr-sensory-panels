...
def get_sqlalchemy_engine():
    ...
    DATABRICKS_SCHEMA) from environment variables.
    ...
    if not catalog:
        raise ValueError("DATABRICKS_CATALOG environment variable not set.")
    if not schema:
        raise ValueError("DATABRICKS_SCHEMA environment variable not set.")
